...
- Duplicate resolution remains the reviewed merge command. Email and phone are candidate signals, never merge authority.
...
owner-approved (OD-02/OD-03 suffice for U1a; OD-07/OD-08 gate later units), the four documents are
