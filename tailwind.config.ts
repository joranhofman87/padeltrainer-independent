  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        lift: "0 1px 2px rgba(20,30,60,.06), 0 18px 40px rgba(20,30,60,.10)",
        cta:  "0 8px 20px rgba(249,115,22,.28)",
        mock: "0 1px 2px rgba(20,30,60,.06), 0 30px 60px rgba(20,30,60,.18)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
