...
CS_EVID="$ROOT/cs-evid"; mkdir -p "$CS_EVID"; printf '2026-08-01T18:00:00Z\n' > "$CS_EVID/clone-source-timestamp.txt"
E2EC="$( PATH="$BIN:$PATH" ROLLOUT_EVIDENCE_DIR="$CS_EVID" CLONE_SOURCE_TS='2026-08-01T18:00:00Z' \
