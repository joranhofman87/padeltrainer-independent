...
export function buildShareCardSvg(data: ShareCardData): string {
  ...
  <!-- Logo text -->
  <text x="540" y="80" fill="#F97316" font-size="28" font-weight="700" text-anchor="middle" font-family="system-ui, -apple-system, sans-serif" letter-spacing="1">PADELTRAINER.AI</text>
