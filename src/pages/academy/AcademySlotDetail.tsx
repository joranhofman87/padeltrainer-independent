                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {(detail.min_rating != null || detail.max_rating != null) && (
                      <Badge variant="outline" className="gap-1">
                        {tAcademy('slotDetail.level', 'Level')} {detail.min_rating ?? '?'} – {detail.max_rating ?? '?'}
                      </Badge>
                    )}
                  </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {[
                            ...
                            calculateAge(player.birthDate) != null ? `${calculateAge(player.birthDate)} ${tAcademy('slotDetail.years', 'yr')}` : null,
                          ].filter(Boolean).join(' · ') || '\u00A0'}
                        </p>
                      </div>
                      {player.isGuest && (
                        <Badge variant="outline" className="text-[10px] h-5 px-1.5">{tAcademy('slotDetail.guest', 'Guest')}</Badge>
                      )}
