          ...
          <CardContent className="pt-0">
            {upcomingSlots.length === 0 ? (
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="text-xs">{t('calendar.title')}</TableHead>
                    <TableHead className="text-xs">{t('lessons.form.location')}</TableHead>
                    <TableHead className="text-xs">{t('lessons.form.maxParticipants')}</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
