...
export default function TrainerSignup() {
  ...
  if (showVerification) {
    return <VerificationPending email={email} onBack={() => setShowVerification(false)} />;
  }
      ...
      <TrainerSignupLayout activeRole="trainer" pageTestId="page-signup-trainer">
        <Card className="w-full shadow-sm" data-testid="form-signup-trainer">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription>{t('trainerSignup.cardSubtitle')}</CardDescription>
            <p className="text-xs text-muted-foreground pt-1">{t('trainerSignup.trustLine')}</p>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <Button type="submit" className="w-full h-11" disabled={isLoading} data-testid="btn-signup-submit">
                {isLoading ? t('signUp.loading') : t('trainerSignup.cta')}
              </Button>
            </form>

            <p className="text-center text-sm text-muted-foreground">
              {t('trainerSignup.alreadyHaveAccount')}{' '}
